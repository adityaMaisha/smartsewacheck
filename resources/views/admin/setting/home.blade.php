                        ...
                        <div class="card-body">
                            <div class="panel profile-cover">
                                <div class="profile-cover__img">
                                    <img src="{{ asset('dashboard/img/brand/logo.png') }}" alt="img">
                                ...
                                <div class="profile-cover__action bg-img" style="background-image: url('{{ asset('dashboard/img/media/bg-img.jpg') }}')"></div>
                                            ...
                                            <div class="card custom-card border">
                                                <div class="card-body text-center">
                                                    <div class="user-lock text-center">
                                                        ...
                                                        <a href="profile.php.html"><img alt="avatar" class="rounded-circle" src="../assets/img/users/2.jpg"></a>
                                                     </div>
                                                    <a href="profile.php.html"><h5 class=" mb-1 mt-3 main-content-label">Socrates Itumay</h5></a>
                                            ...
                                            <div class="card custom-card border">
                                                <div class="card-body text-center">
                                                    <div class="user-lock text-center">
                                                        ...
                                                        <a href="profile.php.html"><img alt="avatar" class="rounded-circle" src="../assets/img/users/3.jpg"></a>
                                                    </div>
                                                    <a href="profile.php.html"><h5 class="mb-1 mt-3  main-content-label">Reynante Labares</h5></a>
                                            ...
                                            <div class="card custom-card border">
                                                <div class="card-body text-center">
                                                    <div class="user-lock text-center">
                                                        ...
                                                        <a href="profile.php.html"><img alt="avatar" class="rounded-circle" src="../assets/img/users/4.jpg"></a>
                                                    </div>
                                                    <a href="profile.php.html"><h5 class="mb-1 mt-3 main-content-label">Owen Bongcaras</h5></a>
                                            ...
                                            <div class="card custom-card border">
                                                <div class="card-body text-center">
                                                    <div class="user-lock text-center">
                                                        ...
                                                        <a href="profile.php.html"><img alt="avatar" class="rounded-circle" src="../assets/img/users/8.jpg"></a>
                                                    </div>
                                                    <a href="profile.php.html"><h5 class="mb-1 mt-3 main-content-label">Stephen Metcalfe</h5></a>
                                            ...
                                            <div class="card custom-card border">
                                                <div class="card-body text-center">
                                                    <div class="user-lock text-center">
                                                        ...
                                                        <a href="profile.php.html"><img alt="avatar" class="rounded-circle" src="../assets/img/users/4.jpg"></a>																	</div>
                                                    <a href="profile.php.html"><h5 class="mb-1 mt-3 main-content-label">Owen Bongcaras</h5></a>
                                                    <p class="mb-2 mt-1 tx-inverse">App Developer</p>
                                                    <p class="text-muted text-center mt-1">Lorem Ipsum is not simply popular belief Contrary.</p>
                                                </div>
