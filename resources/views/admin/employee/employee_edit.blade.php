    ...
    <div class="main-content side-content pt-0">
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <form action="{{ route('edit.employee', $employeeID) }}" method="POST" enctype="multipart/form-data" id="employeeFormData">
                    @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row row-sm mg-b-20">
                                        <div class="col-lg-4">
                                            ...
                                            <select class="form-control select2" name="department_uuid" required>
                                                ...
                                                @foreach ($roles_list as $role)
                                                    <option {{ ($getInfo->department_uuid == lock($role->uuid)) ? 'selected' : ''  }} value="{{ lock($role->uuid) }}">{{ $role->title }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input class="form-control" placeholder="Designation" type="text" name="designation" list="designationList" required value="{{ $getInfo->designation }}">
                                            ...
                                            <div class="mg-b-20">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control fc-datepicker" required
                                                        placeholder="MM/DD/YYYY" type="text" name="date_of_birth" value="{{ $getInfo->date_of_birth }}">
                                                </div>
                                    ...
                                    <div class="row row-sm mg-b-20">
                                        <div class="col-lg">
                                            ...
                                            <input class="form-control" placeholder="First Name" type="text" value="{{ $getInfo->employee_first_name }}"
                                        ...
                                        <div class="col-lg mg-t-10 mg-lg-t-0">
                                            ...
                                            <input class="form-control" placeholder="Lasst Name" type="text" value="{{ $getInfo->employee_last_name }}"
                                        ...
                                        <div class="col-lg mg-t-10 mg-lg-t-0">
                                            <p class="mg-b-10">Employee Profile: &nbsp;
                                            <?php if (!empty($getInfo->employee_profile)) {
                                                echo '<a href="' . asset('documents/'.$getInfo->employee_profile) . '" target="_NEW" class="broken_404 text-warning">( <i class="fa-solid fa-eye"></i> <u>View Profile</u> )</a>';
                                            }
                                            ?>
                                            </p>
                                        ...
                                        <div class="col-lg mg-t-10 mg-lg-t-0">
                                            ...
                                            <div class="mg-b-20">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" value="{{ $getInfo->date_of_joining }}"
                                        ...
                                        <div class="col-lg mg-t-10 mg-lg-t-0">
                                            ...
                                            <div class="form-group">
                                                <select name="gender" class="form-control select2" required>
                                                    ...
                                                    <option {{ ($getInfo->gender == 'male') ? 'selected' : '' }} value="male">Male</option>
                                                    <option {{ ($getInfo->gender == 'female') ? 'selected' : '' }} value="female">Female</option>
                                                    <option {{ ($getInfo->gender == 'other') ? 'selected' : '' }} value="other">Other</option>
                                                </select>
                                        ...
                                        <div class="col-lg mg-t-10 mg-lg-t-0">
                                            ...
                                            <div class="form-group ">
                                                <select name="blood_group" class="form-control select2">
                                                    ...
                                                    <option {{ ($getInfo->blood_group == 'A+') ? 'selected' : '' }} value="A+">A+</option>
                                                    <option {{ ($getInfo->blood_group == 'A-') ? 'selected' : '' }} value="A-">A-</option>
                                                    <option {{ ($getInfo->blood_group == 'B+') ? 'selected' : '' }} value="B+">B+</option>
                                                    <option {{ ($getInfo->blood_group == 'B-') ? 'selected' : '' }} value="B-">B-</option>
                                                    <option {{ ($getInfo->blood_group == 'O+') ? 'selected' : '' }} value="O+">O+</option>
                                                    <option {{ ($getInfo->blood_group == 'O-') ? 'selected' : '' }} value="O-">O-</option>
                                                    <option {{ ($getInfo->blood_group == 'AB+') ? 'selected' : '' }} value="AB+">AB+</option>
                                                    <option {{ ($getInfo->blood_group == 'AB-') ? 'selected' : '' }} value="AB-">AB-</option>
                                                </select>
                                            ...
                                            <div class="form-group ">
                                                <select name="country" class="form-control select2" required
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option {{ ($getInfo->country == $country->id) ? 'selected' : '' }} value="{{ $country->id }}">{{ $country->name }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row row-sm mg-b-20">
                                        <div class="col-lg">
                                            ...
                                            <input class="form-control" placeholder="Address" type="text" required value="{{ $getInfo->address }}"
                                                name="address">
                                            <span class="text-danger ERROR__address"></span>
                                        </div>
                                        <div class="col-lg mg-t-10 mg-lg-t-0">
                                            <p class="mg-b-10">Pin Code</p>
                                            <input class="form-control" placeholder="Pin Code" type="number" value="{{ $getInfo->pin_code }}"
                                        ...
                                        <div class="col-lg mg-t-10 mg-lg-t-0">
                                            ...
                                            <input class="form-control" placeholder="Emergency Contact" type="text" value="{{ $getInfo->emergency_contact }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-lg-6">
                                            ...
                                            <input class="form-control" placeholder="Office Email" type="Email" value="{{ $getInfo->office_email }}"
                                                name="office_email" required>
                                            <span class="text-danger ERROR__office_email"></span>
                                        </div>
                                        <div class="col-lg-6">
                                            <p class="mg-b-10">Reset Login Password (Optional)</p>
                                            <input class="form-control" placeholder="New Login Password Setup" type="password" name="password" readonly onfocus="this.removeAttribute('readonly');">
                                            <span class="text-danger ERROR__password"></span>
                                        </div>
                                        <div class="col-lg-6 mt-3 mg-t-10 mg-lg-t-0">
                                            <p class="mg-b-10">Office Mobile</p>
                                            <input class="form-control" placeholder="Office Mobile" type="text" value="{{ $getInfo->office_mobile }}"
                                        ...
                                        <div class="col-lg-6 mt-3 mg-t-10 mg-lg-t-0">
                                            ...
                                            <select class="form-control select2" name="right_to_access" required>
                                                <option {{ ($getInfo->employee_status == 'active') ? 'selected' : '' }} value="active">Active (User can log in from the dashboard)</option>
                                                <option {{ ($getInfo->employee_status == 'inactive') ? 'selected' : '' }} value="inactive">Deactive (User can't log in to the dashboard)</option>
                                            </select>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row row-sm mg-t-20">
                                        ...
                                        <div class="col-lg">
                                            ...
                                            <input class="form-control" placeholder="Card No" type="text" required
                                                name="pan_card_number" pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}" title="Enter Valid Pan Card Number ( Example: ABCTY1234D )" value="{{ $getInfo->pan_card_number }}">
                                                <span class="text-danger ERROR__pan_card_number"></span>
                                        </div>

                                        <div class="col-lg mg-t-10 mg-lg-t-0">
                                            <p class="mg-b-10 fw-bold">Address Proof id No </p>
                                            <input class="form-control" placeholder="Address Proof id No" type="text" value="{{ $getInfo->address_proof_id_no }}" name="address_proof_id_no">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-lg-4 col-md-4  mt-3">
                                            <p class="mg-b-10 fw-bold">Adhaar Card Upload: <b class="text-danger">*</b> &nbsp;
                                            <?php if (!empty($getInfo->upload_adhaar_card_attachment)) {
                                                    echo '<a href="' . asset('documents/'.$getInfo->upload_adhaar_card_attachment) . '" target="_NEW" class="broken_404 text-warning">( <i class="fa-solid fa-eye"></i> <u>View Adhaar Card</u> )</a>';
                                                }
                                            ?>
                                            </p>
                                            <input type="file" class="dropify" data-height="100"
                                                name="upload_adhaar_card_attachment">
                                                <span class="text-danger ERROR__upload_adhaar_card_attachment"></span>
                                        </div>

                                        <div class="col-lg-4 col-md-4  mt-3">
                                            <p class="mg-b-10 fw-bold">PAN Card Upload: <b class="text-danger">*</b> &nbsp;
                                            <?php if (!empty($getInfo->upload_pan_card_attachment)) {
                                                    echo '<a href="' . asset('documents/'.$getInfo->upload_pan_card_attachment) . '" target="_NEW" class="broken_404 text-warning">( <i class="fa-solid fa-eye"></i> <u>View PAN Card</u> )</a>';
                                                }
                                            ?>
                                            </p>
                                            <input type="file" class="dropify" data-height="100"
                                        ...
                                        <div class="col-lg-4 col-md-4 mt-3">
                                            <p class="mg-b-10 fw-bold">Resume Upload: <b class="text-danger">*</b> &nbsp;
                                            <?php if (!empty($getInfo->upload_resume_attachment)) {
                                                    echo '<a href="' . asset('documents/'.$getInfo->upload_resume_attachment) . '" target="_NEW" class="broken_404 text-warning">( <i class="fa-solid fa-eye"></i> <u>View Resume</u> )</a>';
                                                }
                                            ?>
                                            </p>
                                            <input type="file" class="dropify" data-height="100"
                                    ...
                                    <div>
                                        <div class="col-lg-12 p-0">
                                            <p class="mg-b-10 fw-bold">Qualification Certifactes: &nbsp;
                                                <?php if (!empty($getInfo->upload_other_documents)) {
                                                    echo '<a href="' . asset($getInfo->upload_other_documents) . '" target="_NEW" class="text-warning">( <i class="fa-solid fa-eye"></i> <u>View Other Documents</u> )</a>';
                                                }
                                            ?>
                                            </p>
                                            ...
                                            <?php
                                                $upload_other_documents = $getInfo->upload_other_documents;
                                                $files = explode(",", $upload_other_documents);
                                                foreach ($files as $file) {
                                                    $file_extension = strtolower(pathinfo($file, PATHINFO_EXTENSION));
                                                    if (in_array($file_extension, ['jpg', 'png', 'webp', 'jpeg','bmp', 'tiff', 'tif', 'raw'])) {
                                                        echo '<a href="'. asset('documents/'.$file) .'" target="_NEW" class="broken_404"> <img src="' . asset('documents/'.$file) . '" class="img-thumbnail" style="width: 120px; height: 120px;"> </a>';
                                                    } else {
                                                        echo '<a class="newone" href="'.asset('documents/'.$file).'" target="_NEW" class="broken_404" > '.strtoupper(substr($file, -7)).' </a>';
                                                    }
                                                }
                                            ?>
                                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row row-sm mg-b-20">
                                        <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                            ...
                                            <input class="form-control" placeholder="Bank Name" type="text" value="{{ $getInfo->employee_bank_name }}"
                                        ...
                                        <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                            ...
                                            <input class="form-control" placeholder="First Name" type="text" value="{{ $getInfo->bank_account_holder_name }}"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <select class="form-control select2" name="bank_account_type" required>
                                                ...
                                                <option {{ ($getInfo->bank_account_type == 'saving') ? 'selected' : '' }} value="saving">Saving</option>
                                                <option {{ ($getInfo->bank_account_type == 'current') ? 'selected' : '' }} value="current">Current</option>
                                            </select>
                                    ...
                                    <div class="row row-sm mg-b-20">
                                        <div class="col-lg-4">
                                            ...
                                            <input class="form-control" placeholder="Account Number" required value="{{ $getInfo->bank_account_number }}"
                                        ...
                                        <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                            ...
                                            <input class="form-control" placeholder="Confirm Account Number" required value="{{ $getInfo->confirm_account_number }}"
                                        ...
                                        <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                            ...
                                            <input class="form-control" placeholder="IFSC Code" type="text" required value="{{ $getInfo->bank_ifsc_code }}"
                                                name="bank_ifsc_code">
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-lg-4">
                                            ...
                                            <input class="form-control" placeholder="Bank Branch" type="text" required value="{{ $getInfo->bank_branch }}"
                                                name="bank_branch">
                                                <span class="text-danger ERROR__bank_branch"></span>
                                        </div>
                                        <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                            <p class="mg-b-10">Bank City <b class="text-danger">*</b></p>
                                            <input class="form-control" placeholder="Bank City" type="text" required value="{{ $getInfo->bank_city }}"
                                                name="bank_city">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row row-sm mg-b-20">
                                        <div class="col-lg-4">
                                            ...
                                            <input class="form-control" placeholder="Reference (if any)" type="text" value="{{ $getInfo->reference_name }}"
                                                name="reference_name">
        ...
        function getDynamicStates() {
            ...
            $.ajax({
                ...
                complete: function() {
                    ...
                    $(function() {
                        $("#user_state").val("{{ $getInfo->state }}").attr("selected","selected").change();
                        $('#user_state').select2();
                    });
        ...
        function getDynamicCities() {
            ...
            $.ajax({
                ...
                complete: function() {
                    ...
                    $(function() {
                        $("#user_city").val("{{ $getInfo->city }}").attr("selected","selected");
                        $('#user_city').select2();
                    });
