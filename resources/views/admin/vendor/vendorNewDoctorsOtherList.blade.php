...
<div class="main-content side-content pt-0">
    <div class="main-container container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Doctors & Others Vendor</h2>
                ...
                <div class="d-flex">
                    <div class="justify-content-center">
                        ...
                        <button type="button" class="btn btn-primary my-2 btn-icon-text">
                          <a href="{{ route('vendor.new.doctors.other') }}" style="color: white;">  <i class="fa fa-add me-2"></i> Add Doctors & Others Vendor</a>
                        </button>
                    </div>
                </div>
            </div>
                                ...
                                <table class="tableizer-table w-100" id="laravelTable">
                                    ...
                                    <tbody>
                                        @foreach ($getData as $data)
                                            <tr>
                                                <td>{{$data->salutation.'. '.$data->vendor_name}}</td>
                                                <td>{{$data->email_id}}</td>
                                                <td>
                                                    {{$data->mobile_number}}
                                                </td>
                                                ...
                                                <td>
                                                    <a href="{{route('vendor.edit.doctors.other',encrypt($data->admin_id))}}" class="btn btn-sm btn-edit"><i class="fas fa-edit"></i> &nbsp; Edit &nbsp;</a>
...
<script>
    ...
    $('.removeItem').click(function(){
        ...
        let elem = this;
        $.ajax({
            url:`/vendor-delete-doctors-other/${data_delete}`,
            type:'delete',
