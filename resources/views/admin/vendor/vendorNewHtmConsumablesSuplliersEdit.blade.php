    ...
    <div class="main-container container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Edit HTM Consumables Suplliers</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Vendor</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit HTM Consumables Suplliers</li>
                    </ol>
                </div>
                <div class="d-flex">
                ...
                <div class="row mt-3 mb-4">
                    <div class="col-12 text-center">
                        <input type="submit" class="btn btn-primary my-2 btn-icon-text" style="color: white;"
                            value="&nbsp; Edit HTM Consumables Suplliers &nbsp;">
                    </div>
                </div>
            </form>
...
<script>
    ...
    $('#employeeFormData').submit(function(e){
        ...
        $.ajax({
            url:`/vendor-update-htm-consumables-suplliers/${setIds}`,
            type:'post',
