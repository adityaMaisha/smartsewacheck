    ...
    <div class="main-container container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Edit Healthcare Professionals Vendor</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Vendor</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Healthcare Professionals Vendor</li>
                    </ol>
                </div>
                <div class="d-flex">
                    <div class="justify-content-center">
                        <button type="button" class="btn btn-primary my-2 btn-icon-text">
                            <a href="{{ route('vendor.list.healthcare.professionals') }}" style="color: white;"> <i class="fa fa-backward me-2"></i> Back</a>
                        </button>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row row-sm mg-b-20">
                                    <div class="col-lg-4">
                                        ...
                                        <input class="form-control" type="text"
                                            name="vendor_type" value="Healthcare Professionals" readonly>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-sm mg-t-20">
                                    ...
                                    <div class="col-lg-6 col-md-4  mt-3">
                                        ...
                                        <input type="file" class="" id="gst_certificate" data-height="200" data-default-file="{{asset($editData->gst_certificate)}}"
                ...
                <div class="row mt-3 mb-4">
                    <div class="col-12 text-center">
                        <input type="submit" class="btn btn-primary my-2 btn-icon-text" style="color: white;"
                            value="&nbsp; Edit Healthcare Professionals Vendor &nbsp;">
                    </div>
                </div>
            </form>
...
<script>
    ...
    $('#employeeFormData').submit(function(e){
        ...
        $.ajax({
            url:`/vendor-update-healthcare-professionals/${setIds}`,
            type:'post',
            datatype:'json',
            ...
            success:function(res){
                window.location.href="/vendor-list-healthcare-professionals";
            },
            error:function(res){
                // console.log(res);
                if(res.status==422){
