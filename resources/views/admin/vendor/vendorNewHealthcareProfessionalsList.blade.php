...
<div class="main-content side-content pt-0">
    <div class="main-container container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Healthcare Professionals Vendor</h2>
                ...
                <div class="d-flex">
                    <div class="justify-content-center">
                        ...
                        <button type="button" class="btn btn-primary my-2 btn-icon-text">
                          <a href="{{ route('vendor.new.healthcare.professionals') }}" style="color: white;">  <i class="fa fa-add me-2"></i> Add Healthcare Professionals Vendor</a>
                        </button>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        @foreach ($getData as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('vendor.edit.healthcare.professionals',encrypt($data->admin_id))}}" class="btn btn-sm btn-edit"><i class="fas fa-edit"></i> &nbsp; Edit &nbsp;</a>
...
<script>
    ...
    $('.removeItem').click(function(){
        ...
        let elem = this;
        $.ajax({
            url:`/vendor-delete-healthcare-professionals/${data_delete}`,
            type:'delete',
