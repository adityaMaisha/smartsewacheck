                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-sm mg-b-20">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input class="form-control" type="text"
                                            name="vendor_name" value="{{$vendor->vendor_name}}" placeholder="Enter Name">
                                ...
                                <div class="row row-sm mg-b-20">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input class="form-control" placeholder="Services" type="text" name="services" value="{{$vendor->services}}" list="serviceList" >
                                ...
                                <div class="row row-sm mg-b-20">
                                    ...
                                    <div class="col-lg-8 mg-t-10 mg-lg-t-0">
                                        ...
                                        <input value="{{$vendor->email_id}}" class="form-control" placeholder="Enter Email" type="email" name="email_id"  readonly onfocus="this.removeAttribute('readonly');">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-sm">
                                    <div class="col-lg-6">
                                        ...
                                        <input class="form-control" placeholder="Office Email" type="Email" value="{{$vendor->office_email}}" readonly onfocus="this.removeAttribute('readonly');"
                                            name="office_email" >
                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-sm mg-t-20">
                                    <div class="col-lg-4">
                                        ...
                                        <input value="{{$vendor->adhaar_card_number}}" class="form-control" placeholder="Adhaar Card No" type="text"
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input value="{{$vendor->pan_card_number}}" class="form-control" placeholder="Card No" type="text"
                                      ...
                                      <div class="col-lg-4">
                                        ...
                                        <input value="{{$vendor->gst_number}}" class="form-control" placeholder="GST No" type="text"
                                ...
                                <div>
                                    <div class="col-lg-12 p-0">
                                        ...
                                        <input type="file" class="dropify" data-height="100" name="upload_other_documents[]" multiple data-default-file="{{asset('documents/'.$vendor->upload_other_documents)}}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-sm mg-b-20">
                                    ...
                                    <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                        ...
                                        <input class="form-control" placeholder="IFSC Code" type="text" value="{{$vendor->bank_ifsc_code}}"
                                            name="bank_ifsc_code">
                                ...
                                <div class="row row-sm">
                                    <div class="col-lg-4">
                                        ...
                                        <input class="form-control" placeholder="Bank Branch" type="text" value="{{$vendor->bank_branch}}"
                                            name="bank_branch">
                                            <span class="text-danger ERROR__bank_branch"></span>
                                    </div>
                                    <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                        <p class="mg-b-10">Bank City <b class="text-danger">*</b></p>
                                        <input class="form-control" placeholder="Bank City" type="text" value="{{$vendor->bank_city}}"
                                            name="bank_city">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-sm mg-b-20">
                                    <div class="col-lg-4">
                                        ...
                                        <input class="form-control" placeholder="Reference (if any)" type="text" value="{{$vendor->reference_name}}"
                                            name="reference_name">
