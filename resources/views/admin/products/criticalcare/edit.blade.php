...
<div class="main-content side-content pt-0">
    <div class="main-container container-fluid">
        <div class="inner-body">
            <form enctype="multipart/form-data" id="criticalcareform">
                @csrf

                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Edit Critical Care</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('products.criticalcare.index') }}">Critical Care</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Critical Care</li>
                        </ol>
                    </div>
                    <div class="d-flex">
                        <div class="justify-content-center">
                            <button type="button" class="btn btn-primary my-2 btn-icon-text">
                                <a href="{{ route('products.criticalcare.index') }}" style="color: white;"> <i class="fa fa-backward me-2"></i> Back</a>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="mb-4 hny_tt">
                                <h6 class="main-content-label mb-1">Critical Care Information</h6>
                            </div>
                            <div class="alert alert-danger d-none" id="formerror"></div>
                            <div class="card-body">
                                <div class="row row-sm mg-b-20">
                                    <div class="col-md-4">
                                        <p class="mg-b-10">Critical Care Name <b class="text-danger">*</b></p>
                                        <input
                                            class="form-control"
                                            placeholder="Critical Care Name"
                                            type="text"
                                            name="name"
                                            value="{{$editData->name}}"
                                        />
                                    ...
                                    <div class="col-md-4">
                                        <p class="mg-b-10">Critical Care Price <b class="text-danger">*</b></p>
                                        <input
                                            class="form-control"
                                            placeholder="Critical Care Price"
                                            type="text"
                                            name="price"
                                    ...
                                    <div class="col-md-4">
                                        <p class="mg-b-10">Critical Care Discount Price <b class="text-danger">*</b></p>
                                        <input
                                            class="form-control"
                                            placeholder="Critical Care Discount Price"
                                            type="text"
                                            name="discount_price"
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <p class="mg-b-10">Critical Care Image<b class="text-danger">*</b></p>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <p class="mg-b-10">Critical Care Description <b class="text-danger">*</b></p>
                                        <textarea rows="5" class="form-control" name="description">{{$editData->description}}</textarea>
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        <p class="mg-b-10">Critical Care Instructions <b class="text-danger">*</b></p>
                                ...
                                <div class="row mt-3 mb-4">
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-primary my-2 btn-icon-text">Edit Critical care <i class="fa fa-add"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
<script>
    $('#criticalcareform').submit(function(e){
        e.preventDefault();
        let formid = "<?php print_r(encrypt($editData->_id)) ?>";
        $.ajax({
            url:`/products/criticalcare/update/${formid}`,
            type:'POST',
            data:new FormData(document.getElementById('criticalcareform')),
            contentType:false,
            processData:false,
            ...
            success:function(res){
                // console.log('success');
                // console.log(res);
                window.location.href='/products/criticalcare';
            },
            error:function(res){
                console.log('error');
                console.log(res);
