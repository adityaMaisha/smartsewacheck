        ...
        <div class="inner-body">
            <form enctype="multipart/form-data" id="criticalcareform">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Create New Critical Care</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('products.criticalcare.index') }}">Home Care</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create New Critical Care</li>
                        </ol>
                    </div>
                    <div class="d-flex">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3 mb-4">
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-primary my-2 btn-icon-text">Add New Critical care <i class="fa fa-add"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
