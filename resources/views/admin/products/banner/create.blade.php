        ...
        <div class="inner-body">
            <form enctype="multipart/form-data" id="bannerform">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Create New Banner</h2>
                        <ol class="breadcrumb">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <select name="category" class="form-control select2" >
                                                ...
                                                <option value="SmartHealthCheckupModel">Smart Health Checkup</option>
                                            </select>
                                ...
                                <div class="row mt-3 mb-4">
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-primary my-2 btn-icon-text">Add New Banner <i class="fa fa-add"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            success:function(res){
                ...
                $.each(res.data,function(listIndex,listData){
                    ...
                    $('select[name="offer_on[]"]').append(`
                        <option value="${listData._id}">${listData.name}</option>
                    `)
                });
            },
            error:function(res){
