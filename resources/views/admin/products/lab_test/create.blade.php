...
<div class="main-content side-content pt-0">
    <div class="main-container container-fluid">
        <div class="inner-body">
            <form enctype="multipart/form-data" id="labTest">
                @csrf

                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Create New Lab Test</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('products.labtest') }}">Lab Test</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create New Lab Test</li>
                        </ol>
                    </div>
                    <div class="d-flex">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3 mb-4">
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-primary my-2 btn-icon-text">Add New Lab Test <i class="fa fa-add"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $('#labTest').submit(function(e){
        ...
        $.ajax({
            url:'/products/labtests',
            type:'POST',
            data:new FormData(document.getElementById('labTest')),
            contentType:false,
            processData:false,
            datatype:'json',
