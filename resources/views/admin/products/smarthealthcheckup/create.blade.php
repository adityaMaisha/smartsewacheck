                            ...
                            <div class="card-body">
                                <div class="row row-sm mg-b-20">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        ...
                                        <textarea class="form-control" placeholder="Instructions" name="instructions"></textarea>
                                    </div>
                                ...
                                <div class="row mt-3 mb-4">
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-primary my-2 btn-icon-text">Add New Smart Health Checkup <i class="fa fa-add"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $('#smarthealthcheckup').submit(function(e){
        ...
        $.ajax({
            url:'/products/smarthealthcheckup',
            type:'POST',
