...
<div class="main-content side-content pt-0">
    <div class="main-container container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Smart Health Checkups</h2>
                ...
                <div class="d-flex">
                    <div class="justify-content-center">
                        ...
                        <button type="button" class="btn btn-primary my-2 btn-icon-text">
                          <a href="{{ route('products.smarthealthcheckup.create') }}" style="color: white;">  <i class="fa fa-add me-2"></i> Add New Smart Health Checkups</a>
                        </button>
                                    ...
                                    <tbody>
                                        @foreach ($getDatas as $getData)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('products.smarthealthcheckup.edit',encrypt($getData->_id))}}" class="btn btn-sm btn-edit"><i class="fas fa-edit"></i> &nbsp; Edit &nbsp;</a>
...
<script>
    $('.removeItem').click(function(){
        ...
        let elem = this;
        $.ajax({
            url:`/products/smarthealthcheckup/${data_delete}`,
            type:'delete',
