...
<div class="main-content side-content pt-0">
    <div class="main-container container-fluid">
        <div class="inner-body">
            <form enctype="multipart/form-data" id="smarthealthcheckup">
                @csrf

                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Create New Smart Health Checkup</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('products.smarthealthcheckup.index') }}">Smart Health Checkup</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create New Smart Health Checkup</li>
                        </ol>
                    </div>
                    <div class="d-flex">
                        <div class="justify-content-center">
                            <button type="button" class="btn btn-primary my-2 btn-icon-text">
                                <a href="{{ route('products.smarthealthcheckup.index') }}" style="color: white;"> <i class="fa fa-backward me-2"></i> Back</a>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="mb-4 hny_tt">
                                <h6 class="main-content-label mb-1">Smart Health Checkup Information</h6>
                            </div>
                            <div class="alert alert-danger d-none" id="formerror"></div>
                            <div class="card-body">
                                <div class="row row-sm mg-b-20">
                                    <div class="col-md-4">
                                        <p class="mg-b-10">Checkup Name <b class="text-danger">*</b></p>
                                        <input
                                            class="form-control"
                                    ...
                                    <div class="col-md-4">
                                        <p class="mg-b-10">Checkup Image<b class="text-danger">*</b></p>
                                        <div class="custom-file">
                                            <input type="file" class="form-control" name="checkup_image" accept="image/*"/>
                                            <a href="{{asset($editData->checkup_image)}}" target="_blank">Click here to preview</a>
                                          </div>
                                    </div>
                                    <div class="col-md-4">
                                        <p class="mg-b-10">Checkup Price<b class="text-danger">*</b></p>
                                        <input
                                            class="form-control"
                                            placeholder="Checkup Price"
                                            type="text"
                                            name="checkup_price"
                                            value="{{$editData->checkup_price}}"
                                        />
                                    </div>
                                    <div class="col-md-4 mt-3">
                                        <p class="mg-b-10">Discount Price<b class="text-danger">*</b></p>
                                        <input
                                            class="form-control"
                                    ...
                                    <div class="col-md-4 mt-3">
                                        ...
                                        <textarea class="form-control" placeholder="Description" name="description">{{$editData->description}}</textarea>
                                    </div>
                                    <div class="col-md-4 mt-3">
                                        <p class="mg-b-10">Instructions<b class="text-danger">*</b></p>
                                        <textarea class="form-control" placeholder="Instructions" name="instructions">{{$editData->instructions}}</textarea>
                                    </div>
                                ...
                                <div class="row mt-3 mb-4">
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-primary my-2 btn-icon-text">Edit Smart Health Checkup <i class="fa fa-add"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
<script>
    $('#smarthealthcheckup').submit(function(e){
        e.preventDefault();
        let formid = "<?php print_r(encrypt($editData->_id)) ?>";
        $.ajax({
            url:`/products/smarthealthcheckup/update/${formid}`,
            type:'POST',
            data:new FormData(document.getElementById('smarthealthcheckup')),
            contentType:false,
            processData:false,
            ...
            success:function(res){
                // console.log('success');
                // console.log(res);
                window.location.href='/products/smarthealthcheckup';
            },
            error:function(res){
                console.log('error');
                console.log(res);
