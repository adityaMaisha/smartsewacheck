...
<div class="main-content side-content pt-0">
    <div class="main-container container-fluid">
        <div class="inner-body">
            <form enctype="multipart/form-data" id="appointmentform">
                @csrf

                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Create New Appointment With Doctor</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('products.appointmentdoctor.index') }}">Appointment With Doctor</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create New Appointment With Doctor</li>
                        </ol>
                    </div>
                    <div class="d-flex">
                            ...
                            <div class="card-body">
                                <div class="row row-sm mg-b-20">
                                    <div class="col-md-4">
                                        ...
                                        <select name="dr_name" class="form-control select2" >
                                            ...
                                            <option value="Dr. Sk singh">Dr. Sk singh</option>
                                            <option value="Dr. Devinder Patel">Dr. Devinder Patel</option>
                                            <option value="Dr. Yash Chopra">Dr. Yash Chopra</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                          ...
                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="availability[]" value="available_for_hospital_visit">
                                ...
                                <div class="row mt-3 mb-4">
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-primary my-2 btn-icon-text">Add New Appointment With Doctor <i class="fa fa-add"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $('#appointmentform').submit(function(e){
        ...
        $.ajax({
            url:'/products/appointmentdoctor',
            type:'POST',
