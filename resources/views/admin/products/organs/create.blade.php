        ...
        <div class="inner-body">
            <form enctype="multipart/form-data" id="organsform">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Create New Organ</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('products.organs.index') }}">Organs</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create New Organ</li>
                        </ol>
                    </div>
                    <div class="d-flex">
                            ...
                            <div class="card-body">
                                <div class="row row-sm mg-b-20">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="form-control" name="d3_image" accept="image/*"/>
                                          </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row mt-3 mb-4">
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-primary my-2 btn-icon-text">Add New Organ <i class="fa fa-add"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
