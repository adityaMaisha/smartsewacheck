            ...
            <div class="inner-body">
              <div class="page-header">
                <div>
                  ...
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">End Customer Orders</li>
                  </ol>
                </div>
                <div class="d-flex">
                                ...
                                <table class="table table-striped table-hover" style="width:100%" id="example2">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>CUST1234</td>
                                      <td>Customer One</td>
                                      <td>Order Details & Service Details</td>
                                      <td>₹ 99/ -</td>
                                      ...
                                      <td><div class="dropdown">
                                        ...
                                        <div class="dropdown-menu tx-13">
                                            ...
                                            <a class="dropdown-item" href="{{ route('assignlab.form') }}">Assign To Lab</a>
                                          </div>
                                     </div></td>
                                    </tr>
                                  </tbody>
