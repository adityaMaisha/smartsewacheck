...
<link href="https://php.spruko.com/spruha/spruha/assets/plugins/web-fonts/plugin.css" rel="stylesheet">
@section('style')
<style>
        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
              <div class="page-header">
                <div>
                  <h2 class="main-content-title tx-24 mg-b-5">Order Details Of Order ID #SS112233</h2>
                  <ol class="breadcrumb">
                    ...
                    <div class="col-sm-6 col-md-6 col-xl-3">
                        <div class="card custom-card">
                            <div class="card-body text-center">
                                ...
                                <p class="mb-1 text-muted">Completed User</p>
                                <h3 class="mb-0">80</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-xl-3">
                        <div class="card custom-card">
                            <div class="card-body text-center">
                                ...
                                <p class="mb-1 text-muted">Left Amount</p>
                            ...
                            <div class="card-body">
                                <table class="table table-striped table-hover" style="width:100%" id="example2">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td>1</td>
                                      <td><a href="{{ route('order.view.business.clients') }}">SS1122</a></td>
                                      <td>CUST1234</td>
                                      <td>Client One</td>
